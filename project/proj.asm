   ...
   f:	8d 5d e0             	lea    -0x20(%ebp),%ebx
{
  ...
  struct add var1; var1.a0 = 11; var1.b0 = 1111;
  16:	c7 45 e0 0b 00 00 00 	movl   $0xb,-0x20(%ebp)
  int t_id_1 = thread_create(&test1, (void *)&var1);
  1d:	53                   	push   %ebx
  1e:	68 b0 00 00 00       	push   $0xb0
  struct add var1; var1.a0 = 11; var1.b0 = 1111;
  23:	c7 45 e4 57 04 00 00 	movl   $0x457,-0x1c(%ebp)
  int t_id_1 = thread_create(&test1, (void *)&var1);
  2a:	e8 41 03 00 00       	call   370 <thread_create>
  2f:	89 c6                	mov    %eax,%esi
  int t_id_2 = thread_create(&test2, (void *)&var1);
  31:	58                   	pop    %eax
  32:	5a                   	pop    %edx
  33:	53                   	push   %ebx
  34:	68 d0 00 00 00       	push   $0xd0
  39:	e8 32 03 00 00       	call   370 <thread_create>

  sleep(100);
  3e:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  int t_id_2 = thread_create(&test2, (void *)&var1);
  45:	89 c3                	mov    %eax,%ebx
  sleep(100);
  47:	e8 88 04 00 00       	call   4d4 <sleep>
  printf(1, "wait for child 1 id = %d\n", t_id_1);
  4c:	83 c4 0c             	add    $0xc,%esp
  4f:	56                   	push   %esi
  50:	68 18 09 00 00       	push   $0x918
  55:	6a 01                	push   $0x1
  57:	e8 54 05 00 00       	call   5b0 <printf>
  printf(1, "wait for child 2 id = %d\n", t_id_2);
  5c:	83 c4 0c             	add    $0xc,%esp
  5f:	53                   	push   %ebx
  60:	68 32 09 00 00       	push   $0x932
  65:	6a 01                	push   $0x1
  67:	e8 44 05 00 00       	call   5b0 <printf>

  thread_join();
  6c:	e8 4f 03 00 00       	call   3c0 <thread_join>
  thread_join();
  71:	e8 4a 03 00 00       	call   3c0 <thread_join>


  printf(1, "\na=%d", var1.a0);
  76:	83 c4 0c             	add    $0xc,%esp
  79:	ff 75 e0             	pushl  -0x20(%ebp)
  7c:	68 4c 09 00 00       	push   $0x94c
  81:	6a 01                	push   $0x1
  83:	e8 28 05 00 00       	call   5b0 <printf>
  printf(1, "\nb=%d", var1.b0);
  88:	83 c4 0c             	add    $0xc,%esp
  8b:	ff 75 e4             	pushl  -0x1c(%ebp)
  8e:	68 52 09 00 00       	push   $0x952
  93:	6a 01                	push   $0x1
  95:	e8 16 05 00 00       	call   5b0 <printf>

  printf(1, "\nfinish all.\n");
  9a:	59                   	pop    %ecx
  9b:	5b                   	pop    %ebx
  9c:	68 58 09 00 00       	push   $0x958
  a1:	6a 01                	push   $0x1
  a3:	e8 08 05 00 00       	call   5b0 <printf>


  exit();
  a8:	e8 97 03 00 00       	call   444 <exit>
  ad:	66 90                	xchg   %ax,%ax
  af:	90                   	nop
...
000000b0 <test1>:
{
  ...
  b9:	c7 40 04 35 02 00 00 	movl   $0x235,0x4(%eax)
  sleep(300);
  c0:	68 2c 01 00 00       	push   $0x12c
  c5:	e8 0a 04 00 00       	call   4d4 <sleep>
  exit();
...
000000d0 <test2>:
{
  ...
  d9:	c7 00 37 00 00 00    	movl   $0x37,(%eax)
  exit();
  df:	e8 60 03 00 00       	call   444 <exit>
  e4:	66 90                	xchg   %ax,%ax
  e6:	66 90                	xchg   %ax,%ax
  e8:	66 90                	xchg   %ax,%ax
  ea:	66 90                	xchg   %ax,%ax
 ...
 3c5:	8d 45 e4             	lea    -0x1c(%ebp),%eax
{
 ...
 3da:	89 c3                	mov    %eax,%ebx
  for(int i = 0; i < 64; i++){
 3dc:	b8 00 0d 00 00       	mov    $0xd00,%eax
 ...
 406:	ff b6 04 0d 00 00    	pushl  0xd04(%esi)
 ...
 411:	83 c4 10             	add    $0x10,%esp
      ptrs[i].stack = NULL;
 414:	c7 86 08 0d 00 00 00 	movl   $0x0,0xd08(%esi)
 41b:	00 00 00 
      ptrs[i].busy = 0;
 41e:	c7 86 00 0d 00 00 00 	movl   $0x0,0xd00(%esi)
 425:	00 00 00 
      ptrs[i].ptr = NULL;
 428:	c7 86 04 0d 00 00 00 	movl   $0x0,0xd04(%esi)
 42f:	00 00 00 
    }
  }
  return ret;
...
printf(int fd, const char *fmt, ...)
{
 ...
 734:	eb 1a                	jmp    750 <printf+0x1a0>
          s = "(null)";
 736:	bb 66 09 00 00       	mov    $0x966,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 781:	a1 00 10 00 00       	mov    0x1000,%eax
{
 ...
 7c1:	5b                   	pop    %ebx
  freep = p;
 7c2:	89 15 00 10 00 00    	mov    %edx,0x1000
}
 7c8:	5e                   	pop    %esi
 7c9:	5f                   	pop    %edi
 7ca:	5d                   	pop    %ebp
 ...
 7f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7fc:	89 15 00 10 00 00    	mov    %edx,0x1000
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 819:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 81c:	8b 3d 00 10 00 00    	mov    0x1000,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 867:	73 4f                	jae    8b8 <malloc+0xa8>
    ...
    if(p == freep)
 869:	8b 3d 00 10 00 00    	mov    0x1000,%edi
 ...
 892:	e8 e9 fe ff ff       	call   780 <free>
  return freep;
 897:	a1 00 10 00 00       	mov    0x1000,%eax
 ...
 8c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 8c7:	a3 00 10 00 00       	mov    %eax,0x1000
}
 ...
 8de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 8e0:	c7 05 00 10 00 00 04 	movl   $0x1004,0x1000
 8e7:	10 00 00 
    base.s.size = 0;
 8ea:	bf 04 10 00 00       	mov    $0x1004,%edi
    base.s.ptr = freep = prevp = &base;
 8ef:	c7 05 04 10 00 00 04 	movl   $0x1004,0x1004
 8f6:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8fb:	c7 05 08 10 00 00 00 	movl   $0x0,0x1008
 902:	00 00 00 
    if(p->s.size >= nunits){
