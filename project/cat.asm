...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 68 04 00 00       	call   4a4 <open>
  ...
  57:	e8 30 04 00 00       	call   48c <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 fb 03 00 00       	call   464 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	pushl  (%ebx)
  ...
  73:	e8 58 05 00 00       	call   5d0 <printf>
      exit();
  78:	e8 e7 03 00 00       	call   464 <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 d8 03 00 00       	call   464 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 d4 03 00 00       	call   484 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 b2 03 00 00       	call   47c <read>
  ...
  e6:	e8 e5 04 00 00       	call   5d0 <printf>
      exit();
  eb:	e8 74 03 00 00       	call   464 <exit>
  ...
  f9:	e8 d2 04 00 00       	call   5d0 <printf>
    exit();
  fe:	e8 61 03 00 00       	call   464 <exit>
 ...
 225:	31 f6                	xor    %esi,%esi
{
 ...
 240:	50                   	push   %eax
 241:	6a 00                	push   $0x0
 243:	e8 34 02 00 00       	call   47c <read>
    if (cc < 1)
...
int stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 f2 01 00 00       	call   4a4 <open>
  if (fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 f5 01 00 00       	call   4bc <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 bb 01 00 00       	call   48c <close>
  return r;
...
int thread_create(void (*fn)(void *), void *arg)
{
 ...
 3c2:	e8 3d 01 00 00       	call   504 <clone>
  return thread_id;
 ...
 3e5:	8d 45 e4             	lea    -0x1c(%ebp),%eax
{
 ...
 3fa:	89 c3                	mov    %eax,%ebx
  for(int i = 0; i < 64; i++){
 3fc:	b8 00 0f 00 00       	mov    $0xf00,%eax
 401:	eb 10                	jmp    413 <thread_join+0x33>
 403:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 407:	90                   	nop
 408:	83 c2 01             	add    $0x1,%edx
 40b:	83 c0 0c             	add    $0xc,%eax
 40e:	83 fa 40             	cmp    $0x40,%edx
 411:	74 3f                	je     452 <thread_join+0x72>
    if(ptrs[i].busy == 1 && ptrs[i].stack == stack){
 413:	83 38 01             	cmpl   $0x1,(%eax)
 416:	75 f0                	jne    408 <thread_join+0x28>
 418:	39 48 08             	cmp    %ecx,0x8(%eax)
 41b:	75 eb                	jne    408 <thread_join+0x28>
      free(ptrs[i].ptr);
 41d:	8d 34 52             	lea    (%edx,%edx,2),%esi
 420:	83 ec 0c             	sub    $0xc,%esp
 423:	c1 e6 02             	shl    $0x2,%esi
 426:	ff b6 04 0f 00 00    	pushl  0xf04(%esi)
 42c:	e8 6f 03 00 00       	call   7a0 <free>
      ptrs[i].stack = NULL;
      ptrs[i].busy = 0;
      ptrs[i].ptr = NULL;
      break;
 431:	83 c4 10             	add    $0x10,%esp
      ptrs[i].stack = NULL;
 434:	c7 86 08 0f 00 00 00 	movl   $0x0,0xf08(%esi)
 43b:	00 00 00 
      ptrs[i].busy = 0;
 43e:	c7 86 00 0f 00 00 00 	movl   $0x0,0xf00(%esi)
 445:	00 00 00 
      ptrs[i].ptr = NULL;
 448:	c7 86 04 0f 00 00 00 	movl   $0x0,0xf04(%esi)
 44f:	00 00 00 
    }
  }
  return ret;
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e1:	0f 84 b8 00 00 00    	je     69f <printf+0xcf>
  ap = (uint*)(void*)&fmt + 1;
 ...
 619:	e8 66 fe ff ff       	call   484 <write>
 ...
 679:	e8 06 fe ff ff       	call   484 <write>
        putc(fd, c);
      } else {
 ...
 68d:	e8 f2 fd ff ff       	call   484 <write>
  for(i = 0; fmt[i]; i++){
 ...
 701:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 704:	e8 7b fd ff ff       	call   484 <write>
        ap++;
 ...
 77b:	57                   	push   %edi
 77c:	53                   	push   %ebx
 77d:	e8 02 fd ff ff       	call   484 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7a1:	a1 00 12 00 00       	mov    0x1200,%eax
{
 ...
 7e1:	5b                   	pop    %ebx
  freep = p;
 7e2:	89 15 00 12 00 00    	mov    %edx,0x1200
}
 7e8:	5e                   	pop    %esi
 7e9:	5f                   	pop    %edi
 7ea:	5d                   	pop    %ebp
 ...
 819:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 81c:	89 15 00 12 00 00    	mov    %edx,0x1200
    p->s.size += bp->s.size;
 822:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
 825:	8b 43 f8             	mov    -0x8(%ebx),%eax
...
malloc(uint nbytes)
{
 ...
 839:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 83c:	8b 3d 00 12 00 00    	mov    0x1200,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 887:	73 4f                	jae    8d8 <malloc+0xa8>
    ...
    if(p == freep)
 889:	8b 3d 00 12 00 00    	mov    0x1200,%edi
 ...
 89b:	e8 4c fc ff ff       	call   4ec <sbrk>
  if(p == (char*)-1)
 ...
 8b2:	e8 e9 fe ff ff       	call   7a0 <free>
  return freep;
 8b7:	a1 00 12 00 00       	mov    0x1200,%eax
 ...
 8e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 8e7:	a3 00 12 00 00       	mov    %eax,0x1200
}
 ...
 8fe:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 900:	c7 05 00 12 00 00 04 	movl   $0x1204,0x1200
 907:	12 00 00 
    base.s.size = 0;
 90a:	bf 04 12 00 00       	mov    $0x1204,%edi
    base.s.ptr = freep = prevp = &base;
 90f:	c7 05 04 12 00 00 04 	movl   $0x1204,0x1204
 916:	12 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 919:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 91b:	c7 05 08 12 00 00 00 	movl   $0x0,0x1208
 922:	00 00 00 
    if(p->s.size >= nunits){
