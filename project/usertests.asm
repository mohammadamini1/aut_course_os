...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 e9 39 00 00       	call   3a14 <open>
    ...
    exit();
      40:	e8 8f 39 00 00       	call   39d4 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 be 39 00 00       	call   3a14 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 9e 39 00 00       	call   39fc <close>
  ...
  exit();
     10d:	e8 c2 38 00 00       	call   39d4 <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 ee 38 00 00       	call   3a44 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 b6 38 00 00       	call   3a24 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 c2 38 00 00       	call   3a44 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     1ae:	e8 8d 39 00 00       	call   3b40 <printf>
    exit();
     1b3:	e8 1c 38 00 00       	call   39d4 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 f3 3e 00 00       	push   $0x3ef3
     1bf:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     1c5:	e8 76 39 00 00       	call   3b40 <printf>
    exit();
     1ca:	e8 05 38 00 00       	call   39d4 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 d7 3e 00 00       	push   $0x3ed7
     1d6:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     1dc:	e8 5f 39 00 00       	call   3b40 <printf>
    exit();
     1e1:	e8 ee 37 00 00       	call   39d4 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 b6 3e 00 00       	push   $0x3eb6
     1ed:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     1f3:	e8 48 39 00 00       	call   3b40 <printf>
    exit();
     1f8:	e8 d7 37 00 00       	call   39d4 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     211:	e8 2a 39 00 00       	call   3b40 <printf>
  pid = fork();
     216:	e8 b1 37 00 00       	call   39cc <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 07 38 00 00       	call   3a3c <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 f7 37 00 00       	call   3a44 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 bf 37 00 00       	call   3a24 <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 63 37 00 00       	call   39d4 <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 5f 37 00 00       	call   39dc <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 26 3f 00 00       	push   $0x3f26
     285:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     ...
     2a0:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     2a6:	e8 95 38 00 00       	call   3b40 <printf>
      exit();
     2ab:	e8 24 37 00 00       	call   39d4 <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 e9 4d 00 00       	push   $0x4de9
     2b7:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     2bd:	e8 7e 38 00 00       	call   3b40 <printf>
    exit();
     2c2:	e8 0d 37 00 00       	call   39d4 <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 a8 3e 00 00       	push   $0x3ea8
     2ce:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     2d4:	e8 67 38 00 00       	call   3b40 <printf>
      exit();
     2d9:	e8 f6 36 00 00       	call   39d4 <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 12 3f 00 00       	push   $0x3f12
     2e5:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     2eb:	e8 50 38 00 00       	call   3b40 <printf>
      exit();
     2f0:	e8 df 36 00 00       	call   39d4 <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 cd 36 00 00       	call   3a14 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 1f 36 00 00       	call   39d4 <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 e9 4d 00 00       	push   $0x4de9
     3bc:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     3c2:	e8 79 37 00 00       	call   3b40 <printf>
    exit();
     3c7:	e8 08 36 00 00       	call   39d4 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 4d 3f 00 00       	push   $0x3f4d
     3d3:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     3d9:	e8 62 37 00 00       	call   3b40 <printf>
    exit();
     3de:	e8 f1 35 00 00       	call   39d4 <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 61 3f 00 00       	push   $0x3f61
     3ea:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     3f0:	e8 4b 37 00 00       	call   3b40 <printf>
    exit();
     3f5:	e8 da 35 00 00       	call   39d4 <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 cc 5f 00 00    	pushl  0x5fcc
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 f0 35 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 c8 35 00 00       	call   39fc <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 a5 3f 00 00       	push   $0x3fa5
     43d:	e8 d2 35 00 00       	call   3a14 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     46e:	e8 cd 36 00 00       	call   3b40 <printf>
    exit();
     473:	e8 5c 35 00 00       	call   39d4 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 b2 3f 00 00       	push   $0x3fb2
     47f:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     485:	e8 b6 36 00 00       	call   3b40 <printf>
    exit();
     48a:	e8 45 35 00 00       	call   39d4 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 cc 5f 00 00    	pushl  0x5fcc
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 5b 35 00 00       	call   3a14 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 04 35 00 00       	call   39f4 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 e8 34 00 00       	call   39f4 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     52e:	e8 0d 36 00 00       	call   3b40 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 c1 34 00 00       	call   39fc <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 ef 3f 00 00       	push   $0x3fef
     544:	e8 cb 34 00 00       	call   3a14 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     564:	e8 d7 35 00 00       	call   3b40 <printf>
  i = read(fd, buf, 2000);
     569:	83 c4 0c             	add    $0xc,%esp
     56c:	68 d0 07 00 00       	push   $0x7d0
     571:	68 20 87 00 00       	push   $0x8720
     576:	53                   	push   %ebx
     577:	e8 70 34 00 00       	call   39ec <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     598:	e8 a3 35 00 00       	call   3b40 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 57 34 00 00       	call   39fc <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 ef 3f 00 00 	movl   $0x3fef,(%esp)
     5ac:	e8 73 34 00 00       	call   3a24 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 cc 5f 00 00    	pushl  0x5fcc
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 cc 5f 00 00    	pushl  0x5fcc
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 7b 33 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6b3:	89 1d 20 87 00 00    	mov    %ebx,0x8720
    if(write(fd, buf, 512) != 512){
     6b9:	68 00 02 00 00       	push   $0x200
     6be:	68 20 87 00 00       	push   $0x8720
     6c3:	56                   	push   %esi
     6c4:	e8 2b 33 00 00       	call   39f4 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 11 33 00 00       	call   39fc <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 37 41 00 00       	push   $0x4137
     6f4:	e8 1b 33 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     71b:	a1 20 87 00 00       	mov    0x8720,%eax
    ...
    i = read(fd, buf, 512);
     ...
     72f:	68 20 87 00 00       	push   $0x8720
     734:	53                   	push   %ebx
     735:	e8 b2 32 00 00       	call   39ec <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 a6 32 00 00       	call   39fc <close>
  if(unlink("big") < 0){
     756:	c7 04 24 37 41 00 00 	movl   $0x4137,(%esp)
     75d:	e8 c2 32 00 00       	call   3a24 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     857:	e8 e4 32 00 00       	call   3b40 <printf>
  name[0] = 'a';
     85c:	c6 05 10 87 00 00 61 	movb   $0x61,0x8710
  name[2] = '\0';
     863:	83 c4 10             	add    $0x10,%esp
     866:	c6 05 12 87 00 00 00 	movb   $0x0,0x8712
  for(i = 0; i < 52; i++){
     86d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     870:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     873:	88 1d 11 87 00 00    	mov    %bl,0x8711
  for(i = 0; i < 52; i++){
     879:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     87c:	68 02 02 00 00       	push   $0x202
     881:	68 10 87 00 00       	push   $0x8710
     886:	e8 89 31 00 00       	call   3a14 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 69 31 00 00       	call   39fc <close>
  for(i = 0; i < 52; i++){
     893:	83 c4 10             	add    $0x10,%esp
     896:	80 fb 64             	cmp    $0x64,%bl
     899:	75 d5                	jne    870 <createtest+0x30>
  name[0] = 'a';
     89b:	c6 05 10 87 00 00 61 	movb   $0x61,0x8710
  name[2] = '\0';
     8a2:	bb 30 00 00 00       	mov    $0x30,%ebx
     8a7:	c6 05 12 87 00 00 00 	movb   $0x0,0x8712
  for(i = 0; i < 52; i++){
     8ae:	66 90                	xchg   %ax,%ax
    unlink(name);
     8b0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8b3:	88 1d 11 87 00 00    	mov    %bl,0x8711
  for(i = 0; i < 52; i++){
     8b9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8bc:	68 10 87 00 00       	push   $0x8710
     8c1:	e8 5e 31 00 00       	call   3a24 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 cc 5f 00 00    	pushl  0x5fcc
...
000008f0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 1e 31 00 00       	call   3a44 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 06 31 00 00       	call   3a44 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 d2 30 00 00       	call   3a24 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     97e:	e8 bd 31 00 00       	call   3b40 <printf>
    exit();
     983:	e8 4c 30 00 00       	call   39d4 <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 a1 41 00 00       	push   $0x41a1
     98f:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     995:	e8 a6 31 00 00       	call   3b40 <printf>
    exit();
     99a:	e8 35 30 00 00       	call   39d4 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 90 41 00 00       	push   $0x4190
     9a6:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     9ac:	e8 8f 31 00 00       	call   3b40 <printf>
    exit();
     9b1:	e8 1e 30 00 00       	call   39d4 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 7d 41 00 00       	push   $0x417d
     9bd:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     9c3:	e8 78 31 00 00       	call   3b40 <printf>
    exit();
     9c8:	e8 07 30 00 00       	call   39d4 <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     9e1:	e8 5a 31 00 00       	call   3b40 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 d0 5f 00 00       	push   $0x5fd0
     9ed:	68 8d 3f 00 00       	push   $0x3f8d
     9f2:	e8 15 30 00 00       	call   3a0c <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 cc 5f 00 00    	pushl  0x5fcc
     a0d:	e8 2e 31 00 00       	call   3b40 <printf>
    exit();
     a12:	e8 bd 2f 00 00       	call   39d4 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 9a 2f 00 00       	call   39fc <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a6f:	56                   	push   %esi
     a70:	68 20 87 00 00       	push   $0x8720
     a75:	ff 75 e0             	pushl  -0x20(%ebp)
     a78:	e8 6f 2f 00 00       	call   39ec <read>
     ...
     a95:	38 90 20 87 00 00    	cmp    %dl,0x8720(%eax)
  ...
  seq = 0;
    ...
    close(fds[0]);
     adb:	e8 1c 2f 00 00       	call   39fc <close>
     ...
     aeb:	83 c0 01             	add    $0x1,%eax
        buf[i] = seq++;
     aee:	88 90 1f 87 00 00    	mov    %dl,0x871f(%eax)
      for(i = 0; i < 1033; i++)
     ...
     b09:	68 20 87 00 00       	push   $0x8720
     b0e:	ff 75 e4             	pushl  -0x1c(%ebp)
     b11:	e8 de 2e 00 00       	call   39f4 <write>
    ...
    exit();
     b28:	e8 a7 2e 00 00       	call   39d4 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 bb 2e 00 00       	call   39fc <close>
    wait();
     b41:	e8 96 2e 00 00       	call   39dc <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 d4 2f 00 00       	call   3b40 <printf>
      exit();
     b6c:	e8 63 2e 00 00       	call   39d4 <exit>
    ...
    exit();
     b7f:	e8 50 2e 00 00       	call   39d4 <exit>
    ...
    exit();
     b92:	e8 3d 2e 00 00       	call   39d4 <exit>
     ...
     ba0:	e8 9b 2f 00 00       	call   3b40 <printf>
        exit();
     ba5:	e8 2a 2e 00 00       	call   39d4 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 02 2e 00 00       	call   39cc <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 ed 2d 00 00       	call   39cc <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 e8 2d 00 00       	call   39e4 <pipe>
  pid3 = fork();
     bfc:	e8 cb 2d 00 00       	call   39cc <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 be 2d 00 00       	call   39fc <close>
  ...
  close(pfds[1]);
     ...
     c4e:	e8 a9 2d 00 00       	call   39fc <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     c53:	83 c4 0c             	add    $0xc,%esp
     c56:	68 00 20 00 00       	push   $0x2000
     c5b:	68 20 87 00 00       	push   $0x8720
     c60:	ff 75 e0             	pushl  -0x20(%ebp)
     c63:	e8 84 2d 00 00       	call   39ec <read>
  ...
  close(pfds[0]);
     ...
     c76:	e8 81 2d 00 00       	call   39fc <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 73 2d 00 00       	call   3a04 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 6b 2d 00 00       	call   3a04 <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 63 2d 00 00       	call   3a04 <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 28 2d 00 00       	call   39dc <wait>
  wait();
     cb4:	e8 23 2d 00 00       	call   39dc <wait>
  wait();
     cb9:	e8 1e 2d 00 00       	call   39dc <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 b5 2c 00 00       	call   39dc <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 97 2c 00 00       	call   39cc <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 45 2c 00 00       	call   39d4 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 a9 2c 00 00       	call   3a54 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 1a 2c 00 00       	call   39cc <fork>
    ...
    exit();
     e1f:	e8 b0 2b 00 00       	call   39d4 <exit>
     ...
     e3a:	e8 c5 2b 00 00       	call   3a04 <kill>
      exit();
     e3f:	e8 90 2b 00 00       	call   39d4 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 89 2b 00 00       	jmp    39dc <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 a3 2b 00 00       	call   3a24 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 e3 42 00 00       	push   $0x42e3
     e8d:	e8 82 2b 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 20 2b 00 00       	call   39cc <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 13 2b 00 00       	call   39f4 <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 d1 2a 00 00       	call   39dc <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 e3 2a 00 00       	call   39fc <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 e3 42 00 00       	push   $0x42e3
     f22:	e8 ed 2a 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 9b 2a 00 00       	call   39ec <read>
  ...
  close(fd);
     ...
     f86:	e8 71 2a 00 00       	call   39fc <close>
  unlink("sharedfd");
     f8b:	c7 04 24 e3 42 00 00 	movl   $0x42e3,(%esp)
     f92:	e8 8d 2a 00 00       	call   3a24 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 d4 29 00 00       	call   39d4 <exit>
    ...
    exit();
    100e:	e8 c1 29 00 00       	call   39d4 <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 c0 29 00 00       	call   3a24 <unlink>
    pid = fork();
    1064:	e8 63 29 00 00       	call   39cc <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 4f 29 00 00       	call   39dc <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 48 29 00 00       	call   39dc <wait>
    1094:	e8 43 29 00 00       	call   39dc <wait>
    1099:	e8 3e 29 00 00       	call   39dc <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 62 29 00 00       	call   3a14 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10c8:	68 20 87 00 00       	push   $0x8720
    10cd:	ff 75 d4             	pushl  -0x2c(%ebp)
    10d0:	e8 17 29 00 00       	call   39ec <read>
    ...
    10e3:	0f be 88 20 87 00 00 	movsbl 0x8720(%eax),%ecx
    ...
    1104:	e8 f3 28 00 00       	call   39fc <close>
    if(total != 12*500){
    ...
    111e:	e8 01 29 00 00       	call   3a24 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1157:	6a 01                	push   $0x1
    1159:	e8 e2 29 00 00       	call   3b40 <printf>
          exit();
    115e:	e8 71 28 00 00       	call   39d4 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 a3 28 00 00       	call   3a14 <open>
      if(fd < 0){
    ...
    118b:	68 20 87 00 00       	push   $0x8720
    ...
    11a0:	68 20 87 00 00       	push   $0x8720
    11a5:	56                   	push   %esi
    11a6:	e8 49 28 00 00       	call   39f4 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 15 28 00 00       	call   39d4 <exit>
        printf(1, "create failed\n");
    11bf:	51                   	push   %ecx
    11c0:	51                   	push   %ecx
    11c1:	68 af 45 00 00       	push   $0x45af
    11c6:	6a 01                	push   $0x1
    11c8:	e8 73 29 00 00       	call   3b40 <printf>
        exit();
    11cd:	e8 02 28 00 00       	call   39d4 <exit>
    11d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      printf(1, "fork failed\n");
    11d8:	83 ec 08             	sub    $0x8,%esp
    11db:	68 e9 4d 00 00       	push   $0x4de9
    11e0:	6a 01                	push   $0x1
    11e2:	e8 59 29 00 00       	call   3b40 <printf>
      exit();
    11e7:	e8 e8 27 00 00       	call   39d4 <exit>
      printf(1, "wrong length %d\n", total);
    11ec:	50                   	push   %eax
    11ed:	53                   	push   %ebx
    11ee:	68 41 43 00 00       	push   $0x4341
    11f3:	6a 01                	push   $0x1
    11f5:	e8 46 29 00 00       	call   3b40 <printf>
      exit();
    11fa:	e8 d5 27 00 00       	call   39d4 <exit>
          printf(1, "write failed %d\n", n);
    11ff:	52                   	push   %edx
    1200:	50                   	push   %eax
    1201:	68 24 43 00 00       	push   $0x4324
    1206:	6a 01                	push   $0x1
    1208:	e8 33 29 00 00       	call   3b40 <printf>
          exit();
    120d:	e8 c2 27 00 00       	call   39d4 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 8d 27 00 00       	call   39cc <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 82 27 00 00       	call   39dc <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 78 27 00 00       	call   39dc <wait>
    1264:	e8 73 27 00 00       	call   39dc <wait>
    1269:	e8 6e 27 00 00       	call   39dc <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 66 27 00 00       	call   3a14 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 2a 27 00 00       	call   39fc <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 14 27 00 00       	call   3a24 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 ee 27 00 00       	call   3b40 <printf>
        exit();
    1352:	e8 7d 26 00 00       	call   39d4 <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 75 26 00 00       	call   3a14 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 4d 26 00 00       	call   39fc <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 56 26 00 00       	call   3a24 <unlink>
    ...
    13dc:	6a 01                	push   $0x1
    13de:	e8 5d 27 00 00       	call   3b40 <printf>
            exit();
    13e3:	e8 ec 25 00 00       	call   39d4 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 df 25 00 00       	call   39d4 <exit>
    ...
    1400:	e8 3b 27 00 00       	call   3b40 <printf>
        exit();
    1405:	e8 ca 25 00 00       	call   39d4 <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 27 27 00 00       	call   3b40 <printf>
      exit();
    1419:	e8 b6 25 00 00       	call   39d4 <exit>
          printf(1, "create failed\n");
    141e:	83 ec 08             	sub    $0x8,%esp
    1421:	68 af 45 00 00       	push   $0x45af
    1426:	6a 01                	push   $0x1
    1428:	e8 13 27 00 00       	call   3b40 <printf>
          exit();
    142d:	e8 a2 25 00 00       	call   39d4 <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 af 25 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 72 25 00 00       	call   39f4 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 72 25 00 00       	call   39fc <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 95 43 00 00       	push   $0x4395
    1493:	e8 7c 25 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 72 25 00 00       	call   3a24 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 45 25 00 00       	call   3a14 <open>
  write(fd1, "yyy", 3);
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 ca 24 00 00       	call   39fc <close>
  unlink("unlinkread");
    1532:	c7 04 24 95 43 00 00 	movl   $0x4395,(%esp)
    1539:	e8 e6 24 00 00       	call   3a24 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 6b 24 00 00       	call   39d4 <exit>
    ...
    exit();
    1577:	e8 58 24 00 00       	call   39d4 <exit>
    ...
    exit();
    158a:	e8 45 24 00 00       	call   39d4 <exit>
    ...
    exit();
    159d:	e8 32 24 00 00       	call   39d4 <exit>
    ...
    exit();
    15b0:	e8 1f 24 00 00       	call   39d4 <exit>
    ...
    exit();
    15c3:	e8 0c 24 00 00       	call   39d4 <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 cb 23 00 00       	call   39f4 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 be 23 00 00       	call   39fc <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 5a 44 00 00       	push   $0x445a
    1645:	68 56 44 00 00       	push   $0x4456
    164a:	e8 e5 23 00 00       	call   3a34 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 bd 23 00 00       	call   3a24 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 56 44 00 00       	push   $0x4456
    1670:	e8 9f 23 00 00       	call   3a14 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 85 23 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a4:	68 20 87 00 00       	push   $0x8720
    16a9:	50                   	push   %eax
    16aa:	e8 3d 23 00 00       	call   39ec <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 38 23 00 00       	call   39fc <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 5a 44 00 00       	push   $0x445a
    16cb:	68 5a 44 00 00       	push   $0x445a
    16d0:	e8 5f 23 00 00       	call   3a34 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 37 23 00 00       	call   3a24 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 56 44 00 00       	push   $0x4456
    16f4:	68 5a 44 00 00       	push   $0x445a
    16f9:	e8 36 23 00 00       	call   3a34 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 1d 23 00 00       	call   3a34 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 8c 22 00 00       	call   39d4 <exit>
    ...
    exit();
    1756:	e8 79 22 00 00       	call   39d4 <exit>
    ...
    exit();
    1769:	e8 66 22 00 00       	call   39d4 <exit>
    ...
    exit();
    177c:	e8 53 22 00 00       	call   39d4 <exit>
    ...
    exit();
    178f:	e8 40 22 00 00       	call   39d4 <exit>
    ...
    exit();
    17a2:	e8 2d 22 00 00       	call   39d4 <exit>
    ...
    exit();
    17b5:	e8 1a 22 00 00       	call   39d4 <exit>
    ...
    exit();
    17c8:	e8 07 22 00 00       	call   39d4 <exit>
    ...
    exit();
    17db:	e8 f4 21 00 00       	call   39d4 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    ...
    17f3:	6a 01                	push   $0x1
    17f5:	e8 46 23 00 00       	call   3b40 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 e5 21 00 00       	call   3a14 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 ba 21 00 00       	call   39fc <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 92 21 00 00       	call   39dc <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 c2 21 00 00       	call   3a24 <unlink>
    pid = fork();
    1862:	e8 65 21 00 00       	call   39cc <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 8a 21 00 00       	call   3a14 <open>
      if(fd < 0){
    ...
    189e:	6a 01                	push   $0x1
    18a0:	e8 9b 22 00 00       	call   3b40 <printf>
        exit();
    18a5:	e8 2a 21 00 00       	call   39d4 <exit>
    18aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      link("C0", file);
    18b0:	83 ec 08             	sub    $0x8,%esp
    18b3:	53                   	push   %ebx
    18b4:	68 11 45 00 00       	push   $0x4511
    18b9:	e8 76 21 00 00       	call   3a34 <link>
    18be:	83 c4 10             	add    $0x10,%esp
      exit();
    18c1:	e8 0e 21 00 00       	call   39d4 <exit>
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 53 21 00 00       	call   3a34 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 f3 20 00 00       	call   39dc <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 01 21 00 00       	call   3a14 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 c0 20 00 00       	call   39ec <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 83 20 00 00       	call   39fc <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 82 20 00 00       	call   3a24 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 7a 20 00 00       	call   3a24 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 72 20 00 00       	call   3a24 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 6a 20 00 00       	call   3a24 <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 12 20 00 00       	call   39dc <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 eb 1f 00 00       	call   39cc <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 04 20 00 00       	call   3a14 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 e4 1f 00 00       	call   39fc <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 f2 1f 00 00       	call   3a14 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 d2 1f 00 00       	call   39fc <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 e0 1f 00 00       	call   3a14 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 c0 1f 00 00       	call   39fc <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 ce 1f 00 00       	call   3a14 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 ae 1f 00 00       	call   39fc <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 ba 20 00 00       	call   3b40 <printf>
      exit();
    1a86:	e8 49 1f 00 00       	call   39d4 <exit>
    ...
    exit();
    1a99:	e8 36 1f 00 00       	call   39d4 <exit>
    ...
    1aac:	e8 8f 20 00 00       	call   3b40 <printf>
        exit();
    1ab1:	e8 1e 1f 00 00       	call   39d4 <exit>
    ...
    1ac4:	e8 77 20 00 00       	call   3b40 <printf>
        exit();
    1ac9:	e8 06 1f 00 00       	call   39d4 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 25 1f 00 00       	call   39fc <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 23 1f 00 00       	call   3a24 <unlink>
  pid = fork();
    1b01:	e8 c6 1e 00 00       	call   39cc <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 e2 1e 00 00       	call   3a24 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 99 1e 00 00       	call   3a14 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 79 1e 00 00       	call   39fc <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 45 1e 00 00       	call   39dc <wait>
  printf(1, "linkunlink ok\n");
    1b97:	83 ec 08             	sub    $0x8,%esp
    1b9a:	68 89 45 00 00       	push   $0x4589
    1b9f:	6a 01                	push   $0x1
    1ba1:	e8 9a 1f 00 00       	call   3b40 <printf>
}
    ...
    1bbd:	e8 72 1e 00 00       	call   3a34 <link>
    ...
    exit();
    1bd8:	e8 f7 1d 00 00       	call   39d4 <exit>
    exit();
    1bdd:	e8 f2 1d 00 00       	call   39d4 <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 13 1e 00 00       	call   3a24 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 a5 45 00 00       	push   $0x45a5
    1c1d:	e8 f2 1d 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 c1 1d 00 00       	call   39fc <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 c8 1d 00 00       	call   3a34 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 97 1d 00 00       	call   3a24 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 6d 1d 00 00       	call   3a24 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 4e 1e 00 00       	call   3b40 <printf>
      exit();
    1cf2:	e8 dd 1c 00 00       	call   39d4 <exit>
    ...
    1d01:	e8 3a 1e 00 00       	call   3b40 <printf>
      exit();
    1d06:	e8 c9 1c 00 00       	call   39d4 <exit>
    ...
    exit();
    1d19:	e8 b6 1c 00 00       	call   39d4 <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 e5 1c 00 00       	call   3a24 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 18 47 00 00 	movl   $0x4718,(%esp)
    1d46:	e8 f1 1c 00 00       	call   3a3c <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 ac 1c 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 6f 1c 00 00       	call   39f4 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 6f 1c 00 00       	call   39fc <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 18 47 00 00 	movl   $0x4718,(%esp)
    1d94:	e8 8b 1c 00 00       	call   3a24 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 8b 1c 00 00       	call   3a3c <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 46 1c 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 09 1c 00 00       	call   39f4 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 09 1c 00 00       	call   39fc <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 72 46 00 00       	push   $0x4672
    1dfc:	e8 13 1c 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 b8 1b 00 00       	call   3a24 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 8e 1b 00 00       	call   3a14 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 a6 1b 00 00       	call   3a44 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 8e 1b 00 00       	call   3a44 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 76 1b 00 00       	call   3a44 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 5e 1b 00 00       	call   3a44 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 14 1b 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f15:	68 20 87 00 00       	push   $0x8720
    1f1a:	50                   	push   %eax
    1f1b:	e8 cc 1a 00 00       	call   39ec <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 c7 1a 00 00       	call   39fc <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 4e 46 00 00       	push   $0x464e
    1f3e:	e8 d1 1a 00 00       	call   3a14 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 b4 1a 00 00       	call   3a14 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 97 1a 00 00       	call   3a14 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 7a 1a 00 00       	call   3a14 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 60 1a 00 00       	call   3a14 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 46 1a 00 00       	call   3a14 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 49 1a 00 00       	call   3a34 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 2c 1a 00 00       	call   3a34 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 0f 1a 00 00       	call   3a34 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 ff 19 00 00       	call   3a3c <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 e7 19 00 00       	call   3a3c <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 cf 19 00 00       	call   3a3c <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 9f 19 00 00       	call   3a24 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 87 19 00 00       	call   3a24 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 8f 19 00 00       	call   3a44 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 77 19 00 00       	call   3a44 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 3f 19 00 00       	call   3a24 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 27 19 00 00       	call   3a24 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 0f 19 00 00       	call   3a24 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 f7 18 00 00       	call   3a24 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 df 18 00 00       	call   3a24 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 5a 18 00 00       	call   39d4 <exit>
    ...
    exit();
    2188:	e8 47 18 00 00       	call   39d4 <exit>
    ...
    exit();
    219b:	e8 34 18 00 00       	call   39d4 <exit>
    ...
    exit();
    21ae:	e8 21 18 00 00       	call   39d4 <exit>
    ...
    exit();
    21c1:	e8 0e 18 00 00       	call   39d4 <exit>
    ...
    exit();
    21d4:	e8 fb 17 00 00       	call   39d4 <exit>
    ...
    exit();
    21e7:	e8 e8 17 00 00       	call   39d4 <exit>
    ...
    exit();
    21fa:	e8 d5 17 00 00       	call   39d4 <exit>
    ...
    exit();
    220d:	e8 c2 17 00 00       	call   39d4 <exit>
    ...
    exit();
    2220:	e8 af 17 00 00       	call   39d4 <exit>
    ...
    exit();
    2233:	e8 9c 17 00 00       	call   39d4 <exit>
    ...
    exit();
    2246:	e8 89 17 00 00       	call   39d4 <exit>
    ...
    exit();
    2259:	e8 76 17 00 00       	call   39d4 <exit>
    ...
    exit();
    226c:	e8 63 17 00 00       	call   39d4 <exit>
    ...
    exit();
    227f:	e8 50 17 00 00       	call   39d4 <exit>
    ...
    exit();
    2292:	e8 3d 17 00 00       	call   39d4 <exit>
    ...
    exit();
    22a5:	e8 2a 17 00 00       	call   39d4 <exit>
    ...
    exit();
    22b8:	e8 17 17 00 00       	call   39d4 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 04 17 00 00       	call   39d4 <exit>
    ...
    exit();
    22de:	e8 f1 16 00 00       	call   39d4 <exit>
    ...
    exit();
    22f1:	e8 de 16 00 00       	call   39d4 <exit>
    ...
    exit();
    2304:	e8 cb 16 00 00       	call   39d4 <exit>
    ...
    exit();
    2317:	e8 b8 16 00 00       	call   39d4 <exit>
    ...
    exit();
    232a:	e8 a5 16 00 00       	call   39d4 <exit>
    ...
    exit();
    233d:	e8 92 16 00 00       	call   39d4 <exit>
    ...
    exit();
    2350:	e8 7f 16 00 00       	call   39d4 <exit>
    ...
    exit();
    2363:	e8 6c 16 00 00       	call   39d4 <exit>
    ...
    exit();
    2376:	e8 59 16 00 00       	call   39d4 <exit>
    ...
    exit();
    2389:	e8 46 16 00 00       	call   39d4 <exit>
    ...
    exit();
    239c:	e8 33 16 00 00       	call   39d4 <exit>
    ...
    exit();
    23af:	e8 20 16 00 00       	call   39d4 <exit>
    ...
    exit();
    23c2:	e8 0d 16 00 00       	call   39d4 <exit>
    ...
    exit();
    23d5:	e8 fa 15 00 00       	call   39d4 <exit>
    ...
    exit();
    23e8:	e8 e7 15 00 00       	call   39d4 <exit>
    ...
    exit();
    23fb:	e8 d4 15 00 00       	call   39d4 <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 ff 15 00 00       	call   3a24 <unlink>
    ...
    243d:	e8 d2 15 00 00       	call   3a14 <open>
    if(fd < 0){
    ...
    244e:	53                   	push   %ebx
    244f:	68 20 87 00 00       	push   $0x8720
    2454:	50                   	push   %eax
    2455:	e8 9a 15 00 00       	call   39f4 <write>
      if(cc != sz){
    ...
    2464:	53                   	push   %ebx
    2465:	68 20 87 00 00       	push   $0x8720
    246a:	56                   	push   %esi
    246b:	e8 84 15 00 00       	call   39f4 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 76 15 00 00       	call   39fc <close>
    unlink("bigwrite");
    2486:	c7 04 24 14 49 00 00 	movl   $0x4914,(%esp)
    248d:	e8 92 15 00 00       	call   3a24 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 7c 16 00 00       	call   3b40 <printf>
        exit();
    24c4:	e8 0b 15 00 00       	call   39d4 <exit>
    ...
    24d3:	e8 68 16 00 00       	call   3b40 <printf>
      exit();
    24d8:	e8 f7 14 00 00       	call   39d4 <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 23 15 00 00       	call   3a24 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 70 49 00 00       	push   $0x4970
    250d:	e8 02 15 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2530:	53                   	push   %ebx
    2531:	68 20 87 00 00       	push   $0x8720
    2536:	e8 f5 11 00 00       	call   3730 <memset>
    if(write(fd, buf, 600) != 600){
    253b:	83 c4 0c             	add    $0xc,%esp
    253e:	68 58 02 00 00       	push   $0x258
    2543:	68 20 87 00 00       	push   $0x8720
    2548:	56                   	push   %esi
    2549:	e8 a6 14 00 00       	call   39f4 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 8f 14 00 00       	call   39fc <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 70 49 00 00       	push   $0x4970
    2576:	e8 99 14 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    259d:	0f be 05 20 87 00 00 	movsbl 0x8720,%eax
    25a4:	d1 fa                	sar    %edx
    25a6:	39 d0                	cmp    %edx,%eax
    25a8:	75 6e                	jne    2618 <bigfile+0x138>
    25aa:	0f be 15 4b 88 00 00 	movsbl 0x884b,%edx
  ...
  for(i = 0; ; i++){
    ...
    25c6:	68 20 87 00 00       	push   $0x8720
    25cb:	56                   	push   %esi
    25cc:	e8 1b 14 00 00       	call   39ec <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 19 14 00 00       	call   39fc <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 25 14 00 00       	call   3a24 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 19 15 00 00       	call   3b40 <printf>
      exit();
    2627:	e8 a8 13 00 00       	call   39d4 <exit>
    ...
    2636:	e8 05 15 00 00       	call   3b40 <printf>
      exit();
    263b:	e8 94 13 00 00       	call   39d4 <exit>
    ...
    264a:	e8 f1 14 00 00       	call   3b40 <printf>
      exit();
    264f:	e8 80 13 00 00       	call   39d4 <exit>
    ...
    265e:	e8 dd 14 00 00       	call   3b40 <printf>
      exit();
    2663:	e8 6c 13 00 00       	call   39d4 <exit>
    ...
    exit();
    2676:	e8 59 13 00 00       	call   39d4 <exit>
    ...
    exit();
    2689:	e8 46 13 00 00       	call   39d4 <exit>
    ...
    exit();
    269c:	e8 33 13 00 00       	call   39d4 <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 6e 13 00 00       	call   3a3c <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 56 13 00 00       	call   3a3c <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 11 13 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 e5 12 00 00       	call   39fc <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 c8 52 00 00       	push   $0x52c8
    2720:	e8 ef 12 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 c7 12 00 00       	call   39fc <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 3c 4a 00 00 	movl   $0x4a3c,(%esp)
    273c:	e8 fb 12 00 00       	call   3a3c <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 e7 12 00 00       	call   3a3c <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 51 12 00 00       	call   39d4 <exit>
    ...
    exit();
    2791:	e8 3e 12 00 00       	call   39d4 <exit>
    ...
    exit();
    27a4:	e8 2b 12 00 00       	call   39d4 <exit>
    ...
    exit();
    27b7:	e8 18 12 00 00       	call   39d4 <exit>
    ...
    exit();
    27ca:	e8 05 12 00 00       	call   39d4 <exit>
    ...
    exit();
    27dd:	e8 f2 11 00 00       	call   39d4 <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 2e 12 00 00       	call   3a3c <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 1e 12 00 00       	call   3a44 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 e6 11 00 00       	call   3a24 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 ce 11 00 00       	call   3a24 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 d6 11 00 00       	call   3a44 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 9e 11 00 00       	call   3a24 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 8a 11 00 00       	call   3a24 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 76 11 00 00       	call   3a24 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 f8 10 00 00       	call   39d4 <exit>
    ...
    exit();
    28ea:	e8 e5 10 00 00       	call   39d4 <exit>
    ...
    exit();
    28fd:	e8 d2 10 00 00       	call   39d4 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 bf 10 00 00       	call   39d4 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 ac 10 00 00       	call   39d4 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 99 10 00 00       	call   39d4 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 86 10 00 00       	call   39d4 <exit>
    ...
    exit();
    295c:	e8 73 10 00 00       	call   39d4 <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 80 10 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 54 10 00 00       	call   39fc <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 25 4b 00 00 	movl   $0x4b25,(%esp)
    29af:	e8 90 10 00 00       	call   3a44 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 46 10 00 00       	call   3a14 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 29 10 00 00       	call   3a14 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 39 10 00 00       	call   3a3c <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 09 10 00 00       	call   3a24 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 fc 0f 00 00       	call   3a34 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 d4 0f 00 00       	call   3a24 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 aa 0f 00 00       	call   3a14 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 90 0f 00 00       	call   3a14 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 5e 0f 00 00       	call   39f4 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 56 0f 00 00       	call   39fc <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 05 0f 00 00       	call   39d4 <exit>
    ...
    exit();
    2add:	e8 f2 0e 00 00       	call   39d4 <exit>
    ...
    exit();
    2af0:	e8 df 0e 00 00       	call   39d4 <exit>
    ...
    exit();
    2b03:	e8 cc 0e 00 00       	call   39d4 <exit>
    ...
    exit();
    2b16:	e8 b9 0e 00 00       	call   39d4 <exit>
    ...
    exit();
    2b29:	e8 a6 0e 00 00       	call   39d4 <exit>
    ...
    exit();
    2b3c:	e8 93 0e 00 00       	call   39d4 <exit>
    ...
    exit();
    2b4f:	e8 80 0e 00 00       	call   39d4 <exit>
    ...
    exit();
    2b62:	e8 6d 0e 00 00       	call   39d4 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 9f 0e 00 00       	call   3a3c <mkdir>
    ...
    2bb0:	e8 8f 0e 00 00       	call   3a44 <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 d8 0d 00 00       	call   39fc <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 00 48 00 00       	push   $0x4800
    2c2f:	e8 f0 0d 00 00       	call   3a24 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 f7 0d 00 00       	call   3a44 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 ce 0e 00 00       	call   3b40 <printf>
      exit();
    2c72:	e8 5d 0d 00 00       	call   39d4 <exit>
    ...
    2c81:	e8 ba 0e 00 00       	call   3b40 <printf>
      exit();
    2c86:	e8 49 0d 00 00       	call   39d4 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 0a 0d 00 00       	call   39cc <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 07 0d 00 00       	call   39dc <wait>
  ...
  if(wait() != -1){
    2cde:	e8 f9 0c 00 00       	call   39dc <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 d3 0c 00 00       	call   39d4 <exit>
    ...
    2d0b:	e8 30 0e 00 00       	call   3b40 <printf>
      exit();
    2d10:	e8 bf 0c 00 00       	call   39d4 <exit>
    ...
    exit();
    2d23:	e8 ac 0c 00 00       	call   39d4 <exit>
    ...
    exit();
    2d36:	e8 99 0c 00 00       	call   39d4 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 d0 0c 00 00       	call   3a5c <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 1f 0c 00 00       	call   39cc <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 98 0c 00 00       	call   3a5c <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 8c 0c 00 00       	call   3a5c <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 f4 0b 00 00       	call   39dc <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 6a 0c 00 00       	call   3a5c <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 59 0c 00 00       	call   3a5c <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e18:	6a 00                	push   $0x0
    2e1a:	e8 3d 0c 00 00       	call   3a5c <sbrk>
  c = sbrk(-4096);
    2e1f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e26:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e28:	e8 2f 0c 00 00       	call   3a5c <sbrk>
  ...
  c = sbrk(0);
    ...
    2e3c:	6a 00                	push   $0x0
    2e3e:	e8 19 0c 00 00       	call   3a5c <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e57:	6a 00                	push   $0x0
    2e59:	e8 fe 0b 00 00       	call   3a5c <sbrk>
  c = sbrk(4096);
    2e5e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e65:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e67:	e8 f0 0b 00 00       	call   3a5c <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e7c:	6a 00                	push   $0x0
    2e7e:	e8 d9 0b 00 00       	call   3a5c <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2edf:	90                   	nop
    ppid = getpid();
    2ee0:	e8 6f 0b 00 00       	call   3a54 <getpid>
    2ee5:	89 c6                	mov    %eax,%esi
    pid = fork();
    2ee7:	e8 e0 0a 00 00       	call   39cc <fork>
    if(pid < 0){
    ...
    wait();
    2efa:	e8 dd 0a 00 00       	call   39dc <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f13:	50                   	push   %eax
    2f14:	e8 cb 0a 00 00       	call   39e4 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f30:	e8 97 0a 00 00       	call   39cc <fork>
    ...
    2f50:	e8 97 0a 00 00       	call   39ec <read>
  ...
  c = sbrk(4096);
    ...
    2f67:	e8 f0 0a 00 00       	call   3a5c <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f82:	50                   	push   %eax
    2f83:	e8 7c 0a 00 00       	call   3a04 <kill>
    wait();
    2f88:	e8 4f 0a 00 00       	call   39dc <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fa3:	6a 00                	push   $0x0
    2fa5:	e8 b2 0a 00 00       	call   3a5c <sbrk>
    2faa:	83 c4 10             	add    $0x10,%esp
    2fad:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fb0:	72 60                	jb     3012 <sbrktest+0x2d2>
  printf(stdout, "sbrk test OK\n");
    2fb2:	83 ec 08             	sub    $0x8,%esp
    2fb5:	68 40 4d 00 00       	push   $0x4d40
    2fba:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    2fc0:	e8 7b 0b 00 00       	call   3b40 <printf>
}
    ...
    303e:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    3044:	e8 f7 0a 00 00       	call   3b40 <printf>
      exit();
    3049:	83 c4 20             	add    $0x20,%esp
    304c:	e8 83 09 00 00       	call   39d4 <exit>
      printf(stdout, "fork failed\n");
    3051:	83 ec 08             	sub    $0x8,%esp
    3054:	68 e9 4d 00 00       	push   $0x4de9
    3059:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    305f:	e8 dc 0a 00 00       	call   3b40 <printf>
      exit();
    3064:	e8 6b 09 00 00       	call   39d4 <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    3069:	0f be 03             	movsbl (%ebx),%eax
    306c:	50                   	push   %eax
    306d:	53                   	push   %ebx
    306e:	68 0c 4d 00 00       	push   $0x4d0c
    3073:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    3079:	e8 c2 0a 00 00       	call   3b40 <printf>
      kill(ppid);
    307e:	89 34 24             	mov    %esi,(%esp)
    3081:	e8 7e 09 00 00       	call   3a04 <kill>
      exit();
    3086:	e8 49 09 00 00       	call   39d4 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    308b:	50                   	push   %eax
    308c:	53                   	push   %ebx
    308d:	68 ec 54 00 00       	push   $0x54ec
    3092:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    3098:	e8 a3 0a 00 00       	call   3b40 <printf>
    exit();
    309d:	e8 32 09 00 00       	call   39d4 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    30a2:	56                   	push   %esi
    30a3:	56                   	push   %esi
    30a4:	68 1c 54 00 00       	push   $0x541c
    30a9:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    30af:	e8 8c 0a 00 00       	call   3b40 <printf>
    exit();
    30b4:	e8 1b 09 00 00       	call   39d4 <exit>
    printf(stdout, "sbrk test fork failed\n");
    30b9:	50                   	push   %eax
    30ba:	50                   	push   %eax
    30bb:	68 be 4c 00 00       	push   $0x4cbe
    30c0:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    30c6:	e8 75 0a 00 00       	call   3b40 <printf>
    exit();
    30cb:	e8 04 09 00 00       	call   39d4 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    30d0:	51                   	push   %ecx
    30d1:	51                   	push   %ecx
    30d2:	68 bc 54 00 00       	push   $0x54bc
    30d7:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    30dd:	e8 5e 0a 00 00       	call   3b40 <printf>
    exit();
    30e2:	e8 ed 08 00 00       	call   39d4 <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30e7:	50                   	push   %eax
    30e8:	50                   	push   %eax
    30e9:	68 25 4d 00 00       	push   $0x4d25
    30ee:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    30f4:	e8 47 0a 00 00       	call   3b40 <printf>
    exit();
    30f9:	e8 d6 08 00 00       	call   39d4 <exit>
    printf(1, "pipe() failed\n");
    30fe:	52                   	push   %edx
    30ff:	52                   	push   %edx
    3100:	68 e1 41 00 00       	push   $0x41e1
    3105:	6a 01                	push   $0x1
    3107:	e8 34 0a 00 00       	call   3b40 <printf>
    exit();
    310c:	e8 c3 08 00 00       	call   39d4 <exit>
    exit();
    3111:	e8 be 08 00 00       	call   39d4 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 d5 4c 00 00       	push   $0x4cd5
    311d:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    3123:	e8 18 0a 00 00       	call   3b40 <printf>
    exit();
    3128:	e8 a7 08 00 00       	call   39d4 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 94 54 00 00       	push   $0x5494
    3134:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    313a:	e8 01 0a 00 00       	call   3b40 <printf>
    exit();
    313f:	e8 90 08 00 00       	call   39d4 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 5c 54 00 00       	push   $0x545c
    314b:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    3151:	e8 ea 09 00 00       	call   3b40 <printf>
    exit();
    3156:	e8 79 08 00 00       	call   39d4 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 f1 4c 00 00       	push   $0x4cf1
    3162:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    3168:	e8 d3 09 00 00       	call   3b40 <printf>
    exit();
    316d:	e8 62 08 00 00       	call   39d4 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319f:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    31a5:	e8 96 09 00 00       	call   3b40 <printf>
    31aa:	83 c4 10             	add    $0x10,%esp
    31ad:	8d 76 00             	lea    0x0(%esi),%esi
    if((pid = fork()) == 0){
    31b0:	e8 17 08 00 00       	call   39cc <fork>
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 9f 08 00 00       	call   3a64 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 93 08 00 00       	call   3a64 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 2b 08 00 00       	call   3a04 <kill>
    wait();
    31d9:	e8 fe 07 00 00       	call   39dc <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 5d 4d 00 00       	push   $0x4d5d
    31e6:	e8 49 08 00 00       	call   3a34 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    320f:	e8 2c 09 00 00       	call   3b40 <printf>
}
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 b1 07 00 00       	call   39d4 <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 68 4d 00 00       	push   $0x4d68
    322b:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    3231:	e8 0a 09 00 00       	call   3b40 <printf>
      exit();
    3236:	e8 99 07 00 00       	call   39d4 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    3251:	e8 ea 08 00 00       	call   3b40 <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    325f:	90                   	nop
    if(uninit[i] != '\0'){
    3260:	80 b8 00 60 00 00 00 	cmpb   $0x0,0x6000(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    ...
    3293:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    3299:	e8 a2 08 00 00       	call   3b40 <printf>
      exit();
    329e:	e8 31 07 00 00       	call   39d4 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 64 07 00 00       	call   3a24 <unlink>
  pid = fork();
    32c0:	e8 07 07 00 00       	call   39cc <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 05 07 00 00       	call   39dc <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 b6 4d 00 00       	push   $0x4db6
    32e1:	e8 2e 07 00 00       	call   3a14 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 02 07 00 00       	call   39fc <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 b6 4d 00 00 	movl   $0x4db6,(%esp)
    3301:	e8 1e 07 00 00       	call   3a24 <unlink>
}
    ...
    3310:	c7 04 85 20 a7 00 00 	movl   $0x5510,0xa720(,%eax,4)
    3317:	10 55 00 00 
    ...
    332a:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    args[MAXARG-1] = 0;
    3330:	c7 05 9c a7 00 00 00 	movl   $0x0,0xa79c
    3337:	00 00 00 
    printf(stdout, "bigarg test\n");
    333a:	e8 01 08 00 00       	call   3b40 <printf>
    exec("echo", args);
    333f:	58                   	pop    %eax
    3340:	5a                   	pop    %edx
    3341:	68 20 a7 00 00       	push   $0xa720
    3346:	68 8d 3f 00 00       	push   $0x3f8d
    334b:	e8 bc 06 00 00       	call   3a0c <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 cd 4d 00 00       	push   $0x4dcd
    3357:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    335d:	e8 de 07 00 00       	call   3b40 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3362:	58                   	pop    %eax
    3363:	5a                   	pop    %edx
    3364:	68 00 02 00 00       	push   $0x200
    3369:	68 b6 4d 00 00       	push   $0x4db6
    336e:	e8 a1 06 00 00       	call   3a14 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 81 06 00 00       	call   39fc <close>
    exit();
    337b:	e8 54 06 00 00       	call   39d4 <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 f6 4d 00 00       	push   $0x4df6
    3387:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    338d:	e8 ae 07 00 00       	call   3b40 <printf>
    exit();
    3392:	e8 3d 06 00 00       	call   39d4 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 dd 4d 00 00       	push   $0x4ddd
    339e:	ff 35 cc 5f 00 00    	pushl  0x5fcc
    33a4:	e8 97 07 00 00       	call   3b40 <printf>
    exit();
    33a9:	e8 26 06 00 00       	call   39d4 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    33c0:	6a 01                	push   $0x1
    33c2:	e8 79 07 00 00       	call   3b40 <printf>
    ...
    3447:	6a 01                	push   $0x1
    3449:	e8 f2 06 00 00       	call   3b40 <printf>
    ...
    3458:	50                   	push   %eax
    3459:	e8 b6 05 00 00       	call   3a14 <open>
    if(fd < 0){
    ...
    347a:	68 20 87 00 00       	push   $0x8720
    347f:	57                   	push   %edi
    3480:	e8 6f 05 00 00       	call   39f4 <write>
      if(cc < 512)
    ...
    3498:	6a 01                	push   $0x1
    349a:	e8 a1 06 00 00       	call   3b40 <printf>
    close(fd);
    349f:	89 3c 24             	mov    %edi,(%esp)
    34a2:	e8 55 05 00 00       	call   39fc <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34c2:	6a 01                	push   $0x1
    34c4:	e8 77 06 00 00       	call   3b40 <printf>
      break;
    ...
    354b:	50                   	push   %eax
    354c:	e8 d3 04 00 00       	call   3a24 <unlink>
  while(nfiles >= 0){
  ...
  printf(1, "fsfull test finished\n");
    ...
    3561:	6a 01                	push   $0x1
    3563:	e8 d8 05 00 00       	call   3b40 <printf>
}
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 35 04 00 00       	call   39cc <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 37 04 00 00       	call   39dc <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 f7 03 00 00       	call   39d4 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 e4 03 00 00       	call   39d4 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 11 04 00 00       	call   3a14 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 46 04 00 00       	call   3a5c <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 c7 03 00 00       	call   39ec <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 cf 03 00 00       	call   39fc <close>
    ...
    3795:	31 f6                	xor    %esi,%esi
{
    ...
    37a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  {
    ...
    37b0:	50                   	push   %eax
    37b1:	6a 00                	push   $0x0
    37b3:	e8 34 02 00 00       	call   39ec <read>
    if (cc < 1)
...
int stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 f2 01 00 00       	call   3a14 <open>
  if (fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 f5 01 00 00       	call   3a2c <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 bb 01 00 00       	call   39fc <close>
  return r;
...
void new_lock(my_lock *l)
{
  ;
    ...
    38d8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    38df:	90                   	nop
...
int thread_create(void (*fn)(void *), void *arg)
{
    ...
    3903:	83 ec 14             	sub    $0x14,%esp
  void *thread_stack_pointer = malloc(PGSIZE * 2);
    3906:	68 00 20 00 00       	push   $0x2000
    390b:	e8 90 04 00 00       	call   3da0 <malloc>

  if (thread_stack_pointer == 0)
    3910:	83 c4 10             	add    $0x10,%esp
    3913:	85 c0                	test   %eax,%eax
    3915:	74 25                	je     393c <thread_create+0x3c>
    return -1;

  // Check allocated stack is complete
  if ((uint)thread_stack_pointer % PGSIZE) // if not complete then add more
    3917:	89 c2                	mov    %eax,%edx
    3919:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
    391f:	74 07                	je     3928 <thread_create+0x28>
    thread_stack_pointer = thread_stack_pointer + (PGSIZE - ((uint)thread_stack_pointer % PGSIZE));
    3921:	29 d0                	sub    %edx,%eax
    3923:	05 00 10 00 00       	add    $0x1000,%eax

  int thread_id = clone(fn, arg, thread_stack_pointer);
    3928:	83 ec 04             	sub    $0x4,%esp
    392b:	50                   	push   %eax
    392c:	ff 75 0c             	pushl  0xc(%ebp)
    392f:	ff 75 08             	pushl  0x8(%ebp)
    3932:	e8 3d 01 00 00       	call   3a74 <clone>
  return thread_id;
    ...
    393c:	c9                   	leave  
    return -1;
    393d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    3942:	c3                   	ret    
    3943:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    394a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

00003950 <thread_join>:
...
int thread_join()
{
  ...
  void* stack;
  int ret = join(&stack);
    3955:	8d 45 e4             	lea    -0x1c(%ebp),%eax
{
    3958:	53                   	push   %ebx
    3959:	83 ec 28             	sub    $0x28,%esp
  int ret = join(&stack);
    395c:	50                   	push   %eax
    395d:	e8 1a 01 00 00       	call   3a7c <join>
  // Checking if all the children are zombie
  for(int i = 0; i < 64; i++){
    if(ptrs[i].busy == 1 && ptrs[i].stack == stack){
    3962:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
    3965:	83 c4 10             	add    $0x10,%esp
  for(int i = 0; i < 64; i++){
    3968:	31 d2                	xor    %edx,%edx
  int ret = join(&stack);
    396a:	89 c3                	mov    %eax,%ebx
  for(int i = 0; i < 64; i++){
    396c:	b8 a0 a7 00 00       	mov    $0xa7a0,%eax
    3971:	eb 10                	jmp    3983 <thread_join+0x33>
    3973:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3977:	90                   	nop
    3978:	83 c2 01             	add    $0x1,%edx
    397b:	83 c0 0c             	add    $0xc,%eax
    397e:	83 fa 40             	cmp    $0x40,%edx
    3981:	74 3f                	je     39c2 <thread_join+0x72>
    if(ptrs[i].busy == 1 && ptrs[i].stack == stack){
    3983:	83 38 01             	cmpl   $0x1,(%eax)
    3986:	75 f0                	jne    3978 <thread_join+0x28>
    3988:	39 48 08             	cmp    %ecx,0x8(%eax)
    398b:	75 eb                	jne    3978 <thread_join+0x28>
      free(ptrs[i].ptr);
    398d:	8d 34 52             	lea    (%edx,%edx,2),%esi
    3990:	83 ec 0c             	sub    $0xc,%esp
    3993:	c1 e6 02             	shl    $0x2,%esi
    3996:	ff b6 a4 a7 00 00    	pushl  0xa7a4(%esi)
    399c:	e8 6f 03 00 00       	call   3d10 <free>
      ptrs[i].stack = NULL;
      ptrs[i].busy = 0;
      ptrs[i].ptr = NULL;
      break;
    39a1:	83 c4 10             	add    $0x10,%esp
      ptrs[i].stack = NULL;
    39a4:	c7 86 a8 a7 00 00 00 	movl   $0x0,0xa7a8(%esi)
    39ab:	00 00 00 
      ptrs[i].busy = 0;
    39ae:	c7 86 a0 a7 00 00 00 	movl   $0x0,0xa7a0(%esi)
    39b5:	00 00 00 
      ptrs[i].ptr = NULL;
    39b8:	c7 86 a4 a7 00 00 00 	movl   $0x0,0xa7a4(%esi)
    39bf:	00 00 00 
    }
  }
  return ret;
}
    39c2:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
SYSCALL(fork)
    39cc:	b8 01 00 00 00       	mov    $0x1,%eax
    39d1:	cd 40                	int    $0x40
    39d3:	c3                   	ret    

000039d4 <exit>:
SYSCALL(exit)
    39d4:	b8 02 00 00 00       	mov    $0x2,%eax
    39d9:	cd 40                	int    $0x40
    39db:	c3                   	ret    

000039dc <wait>:
SYSCALL(wait)
    39dc:	b8 03 00 00 00       	mov    $0x3,%eax
    39e1:	cd 40                	int    $0x40
    39e3:	c3                   	ret    

000039e4 <pipe>:
SYSCALL(pipe)
    39e4:	b8 04 00 00 00       	mov    $0x4,%eax
    39e9:	cd 40                	int    $0x40
    39eb:	c3                   	ret    

000039ec <read>:
SYSCALL(read)
    39ec:	b8 05 00 00 00       	mov    $0x5,%eax
    39f1:	cd 40                	int    $0x40
    39f3:	c3                   	ret    

000039f4 <write>:
SYSCALL(write)
    39f4:	b8 10 00 00 00       	mov    $0x10,%eax
    39f9:	cd 40                	int    $0x40
    39fb:	c3                   	ret    

000039fc <close>:
SYSCALL(close)
    39fc:	b8 15 00 00 00       	mov    $0x15,%eax
    3a01:	cd 40                	int    $0x40
    3a03:	c3                   	ret    

00003a04 <kill>:
SYSCALL(kill)
    3a04:	b8 06 00 00 00       	mov    $0x6,%eax
    3a09:	cd 40                	int    $0x40
    3a0b:	c3                   	ret    

00003a0c <exec>:
SYSCALL(exec)
    3a0c:	b8 07 00 00 00       	mov    $0x7,%eax
    3a11:	cd 40                	int    $0x40
    3a13:	c3                   	ret    

00003a14 <open>:
SYSCALL(open)
    3a14:	b8 0f 00 00 00       	mov    $0xf,%eax
    3a19:	cd 40                	int    $0x40
    3a1b:	c3                   	ret    

00003a1c <mknod>:
SYSCALL(mknod)
    3a1c:	b8 11 00 00 00       	mov    $0x11,%eax
    3a21:	cd 40                	int    $0x40
    3a23:	c3                   	ret    

00003a24 <unlink>:
SYSCALL(unlink)
    3a24:	b8 12 00 00 00       	mov    $0x12,%eax
    3a29:	cd 40                	int    $0x40
    3a2b:	c3                   	ret    

00003a2c <fstat>:
SYSCALL(fstat)
    3a2c:	b8 08 00 00 00       	mov    $0x8,%eax
    3a31:	cd 40                	int    $0x40
    3a33:	c3                   	ret    

00003a34 <link>:
SYSCALL(link)
    3a34:	b8 13 00 00 00       	mov    $0x13,%eax
    3a39:	cd 40                	int    $0x40
    3a3b:	c3                   	ret    

00003a3c <mkdir>:
SYSCALL(mkdir)
    3a3c:	b8 14 00 00 00       	mov    $0x14,%eax
    3a41:	cd 40                	int    $0x40
    3a43:	c3                   	ret    

00003a44 <chdir>:
SYSCALL(chdir)
    3a44:	b8 09 00 00 00       	mov    $0x9,%eax
    3a49:	cd 40                	int    $0x40
    3a4b:	c3                   	ret    

00003a4c <dup>:
SYSCALL(dup)
    3a4c:	b8 0a 00 00 00       	mov    $0xa,%eax
    3a51:	cd 40                	int    $0x40
    3a53:	c3                   	ret    

00003a54 <getpid>:
SYSCALL(getpid)
    3a54:	b8 0b 00 00 00       	mov    $0xb,%eax
    3a59:	cd 40                	int    $0x40
    3a5b:	c3                   	ret    

00003a5c <sbrk>:
SYSCALL(sbrk)
    3a5c:	b8 0c 00 00 00       	mov    $0xc,%eax
    3a61:	cd 40                	int    $0x40
    3a63:	c3                   	ret    

00003a64 <sleep>:
SYSCALL(sleep)
    3a64:	b8 0d 00 00 00       	mov    $0xd,%eax
    3a69:	cd 40                	int    $0x40
    3a6b:	c3                   	ret    

00003a6c <uptime>:
SYSCALL(uptime)
    3a6c:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a71:	cd 40                	int    $0x40
    3a73:	c3                   	ret    
...
// new
SYSCALL(clone)
    3a74:	b8 16 00 00 00       	mov    $0x16,%eax
    3a79:	cd 40                	int    $0x40
    3a7b:	c3                   	ret    

00003a7c <join>:
SYSCALL(join)
    3a7c:	b8 17 00 00 00       	mov    $0x17,%eax
    3a81:	cd 40                	int    $0x40
    3a83:	c3                   	ret    
    3a84:	66 90                	xchg   %ax,%ax
    3a86:	66 90                	xchg   %ax,%ax
    3a88:	66 90                	xchg   %ax,%ax
    3a8a:	66 90                	xchg   %ax,%ax
    3a8c:	66 90                	xchg   %ax,%ax
    ...
    3a9c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3b0e:	56                   	push   %esi
    3b0f:	57                   	push   %edi
    3b10:	e8 df fe ff ff       	call   39f4 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3b51:	0f 84 b8 00 00 00    	je     3c0f <printf+0xcf>
  ap = (uint*)(void*)&fmt + 1;
  ...
  ap = (uint*)(void*)&fmt + 1;
    ...
    3b65:	eb 37                	jmp    3b9e <printf+0x5e>
  ...
  write(fd, &c, 1);
    ...
    3b89:	e8 66 fe ff ff       	call   39f4 <write>
  ...
  write(fd, &c, 1);
    ...
    3be9:	e8 06 fe ff ff       	call   39f4 <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
    ...
    3bfd:	e8 f2 fd ff ff       	call   39f4 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    3c74:	e8 7b fd ff ff       	call   39f4 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    3ceb:	57                   	push   %edi
    3cec:	53                   	push   %ebx
    3ced:	e8 02 fd ff ff       	call   39f4 <write>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3d11:	a1 a0 aa 00 00       	mov    0xaaa0,%eax
{
  ...
  freep = p;
    ...
    3d51:	5b                   	pop    %ebx
  freep = p;
    3d52:	89 15 a0 aa 00 00    	mov    %edx,0xaaa0
}
    3d58:	5e                   	pop    %esi
    3d59:	5f                   	pop    %edi
    3d5a:	5d                   	pop    %ebp
  ...
  freep = p;
    3d8c:	89 15 a0 aa 00 00    	mov    %edx,0xaaa0
    p->s.size += bp->s.size;
    3d92:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    3d95:	8b 43 f8             	mov    -0x8(%ebx),%eax
    3d98:	89 02                	mov    %eax,(%edx)
}
    3d9a:	5b                   	pop    %ebx
    3d9b:	5e                   	pop    %esi
    3d9c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3dac:	8b 3d a0 aa 00 00    	mov    0xaaa0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3dc3:	8b 07                	mov    (%edi),%eax
    if(p->s.size >= nunits){
    3dc5:	8b 48 04             	mov    0x4(%eax),%ecx
    3dc8:	39 f1                	cmp    %esi,%ecx
    3dca:	73 71                	jae    3e3d <malloc+0x9d>
    3dcc:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    3dd2:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3dd7:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    3dda:	8d 0c dd 00 00 00 00 	lea    0x0(,%ebx,8),%ecx
    3de1:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3df9:	8b 3d a0 aa 00 00    	mov    0xaaa0,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3e0b:	e8 4c fc ff ff       	call   3a5c <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3e27:	a1 a0 aa 00 00       	mov    0xaaa0,%eax
    ...
    3e54:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3e57:	a3 a0 aa 00 00       	mov    %eax,0xaaa0
}
    ...
    base.s.ptr = freep = prevp = &base;
    3e70:	c7 05 a0 aa 00 00 a4 	movl   $0xaaa4,0xaaa0
    3e77:	aa 00 00 
    base.s.size = 0;
    3e7a:	bf a4 aa 00 00       	mov    $0xaaa4,%edi
    base.s.ptr = freep = prevp = &base;
    3e7f:	c7 05 a4 aa 00 00 a4 	movl   $0xaaa4,0xaaa4
    3e86:	aa 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e89:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    3e8b:	c7 05 a8 aa 00 00 00 	movl   $0x0,0xaaa8
    3e92:	00 00 00 
    if(p->s.size >= nunits){
