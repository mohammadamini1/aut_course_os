...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 ea 03 00 00       	call   424 <unlink>
 ...
 355:	8d 45 e4             	lea    -0x1c(%ebp),%eax
{
 ...
 36a:	89 c3                	mov    %eax,%ebx
  for(int i = 0; i < 64; i++){
 36c:	b8 20 0c 00 00       	mov    $0xc20,%eax
 ...
 396:	ff b6 24 0c 00 00    	pushl  0xc24(%esi)
 ...
 3a1:	83 c4 10             	add    $0x10,%esp
      ptrs[i].stack = NULL;
 3a4:	c7 86 28 0c 00 00 00 	movl   $0x0,0xc28(%esi)
 3ab:	00 00 00 
      ptrs[i].busy = 0;
 3ae:	c7 86 20 0c 00 00 00 	movl   $0x0,0xc20(%esi)
 3b5:	00 00 00 
      ptrs[i].ptr = NULL;
 3b8:	c7 86 24 0c 00 00 00 	movl   $0x0,0xc24(%esi)
 3bf:	00 00 00 
    }
  }
  return ret;
...
free(void *ap)
{
 ...
 711:	a1 20 0f 00 00       	mov    0xf20,%eax
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 758:	5e                   	pop    %esi
 759:	5f                   	pop    %edi
 75a:	5d                   	pop    %ebp
 ...
 789:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78c:	89 15 20 0f 00 00    	mov    %edx,0xf20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d 20 0f 00 00    	mov    0xf20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7f7:	73 4f                	jae    848 <malloc+0xa8>
    ...
    if(p == freep)
 7f9:	8b 3d 20 0f 00 00    	mov    0xf20,%edi
 ...
 822:	e8 e9 fe ff ff       	call   710 <free>
  return freep;
 827:	a1 20 0f 00 00       	mov    0xf20,%eax
 ...
 86e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 20 0f 00 00 24 	movl   $0xf24,0xf20
 877:	0f 00 00 
    base.s.size = 0;
 87a:	bf 24 0f 00 00       	mov    $0xf24,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 24 0f 00 00 24 	movl   $0xf24,0xf24
 886:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 889:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 88b:	c7 05 28 0f 00 00 00 	movl   $0x0,0xf28
 892:	00 00 00 
    if(p->s.size >= nunits){
